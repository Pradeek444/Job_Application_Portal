...
const PricingTable = () => {
  ...
  return (
    <section>
      ...
      <p>Select the plan that aligns with both your requirements and budgetary constraints. With the flexibility to upgrade or downgrade at any time, you're empowered to adapt your subscription to suit evolving needs seamlessly</p>
