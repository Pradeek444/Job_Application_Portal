...
public class MyConstant {
    ...
    public static final String SWAGGER_INFO_CONTACT_EMAIL = "arunpradeek444@gmail.com";
    public static final String SWAGGER_INFO_CONTACT_URL = "http://localhost:5173/#eight";
